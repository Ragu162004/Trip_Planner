  ...
  return (
    <>
      {isSmall ? (
        ...
        >
          <Card className="grid mt-4 transition-transform duration-300 ease-in-out hover:scale-105 text-left grid-rows-1 grid-cols-[30%_1fr] h-20 custom-500:grid-cols-[25%_1fr] sm:grid-cols-[20%_1fr] custom-435:h-24 gap-2 items-center sm:items-start p-2 sm:h-40 bg-gray-100 border border-black/10 sm:text-left">
            <div className="img h-full rounded-lg bg-gray-200 border border-black/10">
              <img
                src={Url || "/logo.png"}
                className="h-full max-h-48 w-full object-cover"
